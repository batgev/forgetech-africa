...
const LandingPage = () => {
  ...
  return (
    <div
      className="flex flex-col items-center gap-2 h-screen  w-full"
      style={{ background: "linear-gradient(135deg,#ffffff,#f7fbff 40%,#eef6ff 100%" }}
    >
      <Header />

      {/*hero section */}
      <div className="flex-1 flex md:flex-row flex-col gap-8 items-center w-full justify-around md:pl-8  ">
        <div className="flex flex-col leading-snug font-light md:ml-8">
          ...
          <div className="flex gap-4 mt-8 justify-center text-center">
            <Link className="bg-cyan-800 text-white p-2 font-bold w-[40%]">Get Started</Link>
            <Link className="border-2 border-black p-2 w-[40%]">View Portfolio</Link>
          </div>
        </div>
        <div className="pr-2">
          <img
